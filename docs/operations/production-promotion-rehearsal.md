...
| **Migration Compatibility**             | Validate expand-contract rules (no DROP COLUMN / un-defaulted NOT NULL)    | `infra/deploy/production/validate-migrations.sh` | **PASS** | All 29 migrations verified backwards-compatible          |
