...
| ---------------- | ------------------------------------------------------------------------------------ | ---------------------- | ---------- | ----------- |
| DEV-FOUND-001    | A clean machine can bootstrap and run the platform foundation.                       | Execution blueprint M0 | M0         | Complete    |
| SEC-SECRET-001   | No production secret or customer data exists in source, fixtures, or logs.           | Spec 20; M0 S0         | M0         | Complete    |
